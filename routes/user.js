...
router.put('/user/update', md_auth.authenticated, UserController.update); //agregamos el middleware, cuando llame a la ruta /update primero pasará por el middleware y luego sigue con el usercontroler
